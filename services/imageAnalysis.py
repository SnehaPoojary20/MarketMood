...
from services.imageAnalysis import analyze_image


app = FastAPI()
app.add_api_route("/analyze/image/", analyze_image, methods=["POST"])  # ✅ Register Route
...
async def analyze_image(file: UploadFile = File(...)):
    try:
        ...
        # TODO: Add image processing logic (OCR, AI Analysis, etc.)
        return {"message": "Image processing is pending", "image": encoded_image}
